...
public class InvoiceView extends JFrame {
    ...
    public InvoiceView(Object [] data, JTable table){

        Object inv_date = data[4];
        Object usr_name = data[1];
        Object service = data[2];
        Object price = data[3];
        setBounds(200, 50, 1000, 1000);
        setLayout(null);
        setVisible(true);
        ...
        panel1.setBounds(300,100,600,840);
        getContentPane().setBackground(Color.white);

        textArea = new JTextArea();
        textArea.setBounds(70,60,360,450);
...
//        textArea.append("\n" + service + "   " + trans + "\t  " + price);
        ...
        download_pdf.setBounds(150,520,200,50);
